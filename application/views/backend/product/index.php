                        ...
                        <table class="display table table-bordered table-striped table-responsive">
                            ...
                            <?php $no=0; foreach($all as $row): $no++ ?>
                                <tr class="gradeX">
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <button class="btn btn-default" type="button">Pilih</button>
                                            <button data-toggle="dropdown" class="btn btn-default dropdown-toggle" type="button">
                                                <span class="caret"></span>
                                                <span class="sr-only">Toggle Dropdown</span>
                                            </button>
                                            <ul class="dropdown-menu" style="width:10px;min-width:120px;">
                                                <li>
                                                    <a href="javascript:void(0)" onclick="get_update('<?php echo $row->id_product ?>')">
                                                        Edit
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0)" onclick="get_detail('<?php echo $row->id_product ?>')">
                                                        Detail
                                                    </a>
                                                </li>
                                                <li>
                                                   <a href="<?php echo site_url('picture_product/'.$row->id_product) ?>">
                                                        Galeri
                                                    </a>
                                                </li>
                                            </ul>
            ...
            <?php echo form_open_multipart('add_product','class="form-horizontal"'); ?>
                <div class="modal-body" style="height: 450px;overflow-y: scroll;">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" required placeholder="Masukkan Slug/Url" autocomplete="off" class="form-control" name="slug">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="spinner3">
                                <div class="input-group" style="width:250px;">
                                    <input type="text" autocomplete="off" onkeypress="return nomer(this)" class="spinner-input form-control" maxlength="5" name="stock" required>
...
<script type="text/javascript">
    ...
    function writeSlug(value)
    {
      var repSpace=value.replace(" ",'_');
      var repCom=repSpace.replace(/[^A-Z0-9]/ig, '_');
      var slug=repCom.toLowerCase();
      $("[name='slug']").val(slug);
    }
</script>
